...
const ui_factory_1 = require("./01-basic-concept/ui-factory");
const furniture_factory_1 = require("./02-advanced-example/furniture-factory");
// ============================================================================
...
└─────────────────┘  └─────────────────┘  └─────────────────┘
  ...
  `);
    ...
    const factories = [
        new ui_factory_1.WindowsUIFactory(),
        new ui_factory_1.MacOSUIFactory(),
        new ui_factory_1.LinuxUIFactory(),
    ];
  ...
  `);
    ...
    const macFactory = new ui_factory_1.MacOSUIFactory();
 ...
 Factory    Factory             Factory
  `);
    ...
    const furnitureFactories = [
        new furniture_factory_1.ModernFurnitureFactory(),
        new furniture_factory_1.VictorianFurnitureFactory(),
        new furniture_factory_1.ArtDecoFurnitureFactory(),
    ];
    for (const factory of furnitureFactories) {
        console.log(`\n📌 ${factory.getFamilyName()} Style:`);
        console.log(`   ${factory.getDescription()}`);
        const roomSet = new furniture_factory_1.RoomSet(factory);
    ...
    function selectFactoryByBudget(budget) {
        switch (budget) {
            case "low":
                return new furniture_factory_1.ModernFurnitureFactory(); // Most affordable
            case "medium":
                return new furniture_factory_1.ArtDecoFurnitureFactory(); // Mid-range
            case "high":
                return new furniture_factory_1.VictorianFurnitureFactory(); // Most expensive
        }
    }
