...
import { Transport, TruckTransport, ShipTransport, AirplaneTransport } from "./product.interface";
 ...
 */
export abstract class LogisticsCreator {
  /**
   ...
   */
  public planDelivery(packageWeight: number): string {
   ...
   */
  public compareWithStandard(packageWeight: number): string {
    const transport = this.createTransport();
 ...
 */
export class RoadLogistics extends LogisticsCreator {
  /**
 ...
 */
export class SeaLogistics extends LogisticsCreator {
  public createTransport(): Transport {
 ...
 */
export class AirLogistics extends LogisticsCreator {
  public createTransport(): Transport {
