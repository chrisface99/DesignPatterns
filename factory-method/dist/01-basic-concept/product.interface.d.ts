 ...
 */
export declare class TruckTransport implements Transport {
    deliver(): string;
    estimatedDeliveryTime(): number;
    costPerKg(): number;
}
 ...
 */
export declare class ShipTransport implements Transport {
    deliver(): string;
    estimatedDeliveryTime(): number;
    costPerKg(): number;
}
 ...
 */
export declare class AirplaneTransport implements Transport {
    deliver(): string;
    estimatedDeliveryTime(): number;
    costPerKg(): number;
}
