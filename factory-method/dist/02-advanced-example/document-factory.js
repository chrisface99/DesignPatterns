...
exports.XmlExportCreator = exports.PdfExportCreator = exports.JsonExportCreator = exports.CsvExportCreator = exports.DocumentExportCreator = exports.XmlExporter = exports.PdfExporter = exports.JsonExporter = exports.CsvExporter = void 0;
// ============================================================================
...
class JsonExporter {
    ...
    validateData(data) {
        ...
        try {
            ...
            errors.push(`Data contains non-serializable values: ${e.message}`);
        }
        return { valid: errors.length === 0, errors };
    }
}
...
exports.DocumentExportCreator = DocumentExportCreator;
// ============================================================================
 ...
 */
class CsvExportCreator extends DocumentExportCreator {
    createExporter() {
        return new CsvExporter();
    }
}
exports.CsvExportCreator = CsvExportCreator;
/**
 * Concrete Creator: JSON Export Creator
 */
class JsonExportCreator extends DocumentExportCreator {
    createExporter() {
        return new JsonExporter();
    }
}
exports.JsonExportCreator = JsonExportCreator;
/**
 * Concrete Creator: PDF Export Creator
 */
class PdfExportCreator extends DocumentExportCreator {
    createExporter() {
        return new PdfExporter();
    }
}
exports.PdfExportCreator = PdfExportCreator;
/**
 * Concrete Creator: XML Export Creator
 */
class XmlExportCreator extends DocumentExportCreator {
    createExporter() {
        return new XmlExporter();
    }
}
exports.XmlExportCreator = XmlExportCreator;
/**
 * ============================================================================
